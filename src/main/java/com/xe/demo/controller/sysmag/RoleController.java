...
import com.xe.demo.service.sysmag.AuthRoleMenuService;
...
import com.xe.demo.service.sysmag.RoleService;
import com.xe.demo.service.sysmag.UserService;
...
public class RoleController extends BaseController {
	...
	public AjaxResult updateRoleMenu(Integer roleId,String[] menusStr){
        AjaxResult ajaxResult = authRoleMenuService.updateRoleMenu(roleId, menusStr);
        return ajaxResult;
    }

	@RequestMapping("roleMenuPage/{roleid}")
	public String roleMenuPage(@PathVariable("roleid") Integer roleId,Map<String,Object> map){
		map.put("roleId",roleId);
		return "auth/role/role_menu";
	}

	@RequestMapping("getMenus")
	@ResponseBody
	public List<TreeNode>  getMenus(Integer roleId){
		List<TreeNode> menuList = authRoleMenuService.getMenuByRole(roleId);
		return  menuList;
	}
