        ...
        $("#openAppGrid").sgrid({
            columns:[
                ...
                {field:"roleid", text:"操作", style:"text-align:center", formatter:function(index, content, data){
                    ...
                    var roleMenuPageUrl = "admin/role/roleMenuPage/" + content;
...
/*	                    + "&nbsp;<a href='javascript:goPage(\""+roleOperPageUrl+"\");' class='btn btn-xs btn-info'><i class='ace-icon fa fa-th-list'>分配权限</i></a>"*/
                        + "&nbsp;<a href='javascript:showModal(\"绑定菜单\",\""+roleMenuPageUrl+"\");' class='btn btn-xs btn-primary'><i class='ace-icon fa fa-th-list'>分配菜单</i></a>";
                }}
            ],
            cls: "",
